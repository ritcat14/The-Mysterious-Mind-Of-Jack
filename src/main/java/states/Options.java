...
public class Options extends State {
    ...
    public Options() {
        mainPanel = new GuiPanel(100, 100, StateHandler.WIDTH - 200, StateHandler.HEIGHT - 200, Color.LIGHT_GRAY);
        mainPanel.add(new GuiButton(StateHandler.WIDTH - 450, StateHandler.HEIGHT - 350, 200, 100, Color.DARK_GRAY, "BACK") {
            @Override
